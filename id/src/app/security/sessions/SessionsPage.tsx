...
export function SessionsPage({ sessions, currentSessionId }: Props) {
  ...
  return (
    <div className="flex flex-col items-center max-w-3xl mx-auto p-4 w-full">
      <h1 className="text-4xl font-medium mb-16">Active sessions</h1>
...
function SessionsGroup({
  ...
  return (
    <div className="w-full border border-white/25 rounded-lg p-8 mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
      <h2 className="text-2xl font-medium">{name}</h2>
      <div className="grid grid-cols-1 gap-6 divide-y divide-white/25">
  ...
  return (
    <div className="pb-6 px-4 last:pb-0 flex flex-row">
      <div>
        ...
        <p>Last used: {formatter.relativeTime(session.lastUsedAt)}</p>
        {isActive && (
